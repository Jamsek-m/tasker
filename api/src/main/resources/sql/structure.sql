...
create table service_tokens (id varchar(255) not null, user_id varchar(255) not null, token varchar(255) not null, service_id varchar(255) not null, primary key (id));
